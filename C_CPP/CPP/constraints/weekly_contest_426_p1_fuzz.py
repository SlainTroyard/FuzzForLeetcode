...
# File Configs
output_file = "../../../fuzz_outputs/CPP/weekly_contest_426_p1/outputs"  # Output file to store test cases and results
cpp_folder = "../src"  # Folder containing the C++ source code
cpp_file = "weekly_contest_426_p1.cpp"  # C++ source file name
executable_name = "solution"  # Executable name

# Generate a single test case
def generate_test_input():
    n = random.randint(1, 1000)  # Generate a random number within the constraint
    return n
