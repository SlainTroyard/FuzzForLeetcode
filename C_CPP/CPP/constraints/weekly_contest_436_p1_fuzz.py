...
max_n = 10  # Maximum value of n
max_grid_value = 10**5  # Maximum value of grid[i][j]

# File Configs
output_file = "../../../fuzz_outputs/CPP/weekly_contest_436_p1/outputs"  # Output file to store test cases and results
cpp_folder = "../src"  # Folder containing the C++ source code
cpp_file = "weekly_contest_436_p1.cpp"  # C++ source file name
...
def generate_test_input():
    ...
    grid = []
    for _ in range(n):
        row = [random.randint(-max_grid_value, max_grid_value) for _ in range(n)]
        grid.append(row)
    return n, grid
