...
max_n = 100000  # Maximum value for n
min_m = 1  # Minimum value for m
max_m = 100000  # Maximum value for m

# File Configs
output_file = "../../../fuzz_outputs/CPP/weekly_contest_430_p4/outputs"  # Output file to store test cases and results
cpp_folder = "../src"  # Folder containing the C++ source code
cpp_file = "weekly_contest_430_p4.cpp"  # C++ source file name
