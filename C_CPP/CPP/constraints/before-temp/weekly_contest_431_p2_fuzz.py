...
max_string_length = 10**5  # Maximum length of the string
min_string_length = 1  # Minimum length of the string


# File Configs
output_file = "../../../fuzz_outputs/CPP/weekly_contest_431_p2/outputs"  # Output file to store test cases and results
cpp_folder = "../src"  # Folder containing the C++ source code
cpp_file = "weekly_contest_431_p2.cpp"  # C++ source file name
...
def generate_test_input():
    ...
    s = "".join(random.choices(string.ascii_lowercase, k=random.randint(min_string_length, max_string_length)))
    return s
