...
# File Configs
output_file = "../../../fuzz_outputs/CPP/weekly_contest_416_p3/outputs"  # Output file to store test cases and results
cpp_folder = "../src"  # Folder containing the C++ source code
cpp_file = "weekly_contest_416_p3.cpp"  # C++ source file name
