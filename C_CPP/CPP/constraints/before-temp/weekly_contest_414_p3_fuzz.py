...
# File Configs
output_file = "../../../fuzz_outputs/CPP/weekly_contest_414_p3/outputs"  # Output file to store test cases and results
cpp_folder = "../src"  # Folder containing the C++ source code
cpp_file = "weekly_contest_414_p3.cpp"  # C++ source file name
...
def generate_test_input():
    ...
    numsSize = random.randint(min_len, max_len)
    nums = []
...
def format_test_input(test_input):
    formatted_input = f"{len(test_input)}\n"
