...
max_n = 50  # Maximum value of n
max_m = 50  # Maximum value of m
max_val = 2500  # Maximum value of grid[i][j]

# File Configs
output_file = "../../../fuzz_outputs/CPP/weekly_contest_432_p1/outputs"  # Output file to store test cases and results
cpp_folder = "../src"  # Folder containing the C++ source code
cpp_file = "weekly_contest_432_p1.cpp"  # C++ source file name
...
def generate_test_input():
    ...
    grid = [[random.randint(1, max_val) for _ in range(m)] for _ in range(n)]
    return n, m, grid
