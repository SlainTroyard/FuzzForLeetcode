...
max_word_length = 250  # Maximum length of the word
min_word_length = 5  # Minimum length of the word
min_k = 0  # Minimum value of k


# File Configs
output_file = "../../../fuzz_outputs/CPP/weekly_contest_417_p2/outputs"  # Output file to store test cases and results
cpp_folder = "../src"  # Folder containing the C++ source code
cpp_file = "weekly_contest_417_p2.cpp"  # C++ source file name
