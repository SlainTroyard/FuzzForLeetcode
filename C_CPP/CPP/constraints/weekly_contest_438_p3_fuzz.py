...
max_s_length = 10**5  # Maximum length of the string s
min_s_length = 3  # Minimum length of the string s

# File Configs
output_file = "../../../fuzz_outputs/CPP/weekly_contest_438_p3/outputs"  # Output file to store test cases and results
cpp_folder = "../src"  # Folder containing the C++ source code
cpp_file = "weekly_contest_438_p3.cpp"  # C++ source file name
executable_name = "solution"  # Executable name

# TODO: Generate a single test case
def generate_test_input():
    random.seed(time.time())
    # 3 <= s.length <= 10^5, s consists of only digits.
