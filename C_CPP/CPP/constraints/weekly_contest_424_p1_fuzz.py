...
# File Configs
output_file = "../../../fuzz_outputs/CPP/weekly_contest_424_p1/outputs"  # Output file to store test cases and results
cpp_folder = "../src"  # Folder containing the C++ source code
cpp_file = "weekly_contest_424_p1.cpp"  # C++ source file name
    ...
    try:
        ...
        with open(output_file, "w") as f:
            for case_id in range(1, test_cases + 1):
                ...
                # Remove newline if formatted_input ends with one
