...
test_cases = 200  # Number of test cases to generate
max_length = 100  # Maximum length of the string
min_length = 1  # Minimum length of the string

# File Configs
output_file = "../../../fuzz_outputs/CPP/weekly_contest_437_p1/outputs"  # Output file to store test cases and results
cpp_folder = "../src"  # Folder containing the C++ source code
cpp_file = "weekly_contest_437_p1.cpp"  # C++ source file name
executable_name = "solution"  # Executable name

# TODO: Generate a single test case
def generate_test_input():
    random.seed(time.time())
    # 1 <= k <= s.length <= 100, s consists of lowercase English letters only.
