...
max_length = 80000  # Maximum length of the input array
max_value = 1000000  # Maximum value of an element in the input array


# File Configs
output_file = "../../../fuzz_outputs/CPP/weekly_contest_433_p4/outputs"  # Output file to store test cases and results
cpp_folder = "../src"  # Folder containing the C++ source code
cpp_file = "weekly_contest_433_p4.cpp"  # C++ source file name
...
def generate_test_input():
    ...
    nums = [random.randint(-max_value, max_value) for _ in range(n)]
    return n, k, nums
