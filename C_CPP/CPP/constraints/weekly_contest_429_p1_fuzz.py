...
min_array_size = 1  # Minimum number of elements in the array
max_array_size = 100  # Maximum number of elements in the array
min_value = 1  # Minimum value for array elements
max_value = 100  # Maximum value for array elements

# File Configs
output_file = "../../../fuzz_outputs/CPP/weekly_contest_429_p1/outputs"  # Output file to store test cases and results
cpp_folder = "../src"  # Folder containing the C++ source code
cpp_file = "weekly_contest_429_p1.cpp"  # C++ source file name
