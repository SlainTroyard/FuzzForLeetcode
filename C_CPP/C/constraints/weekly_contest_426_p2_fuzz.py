...
# File Configs
output_file = "../../../fuzz_outputs/C/weekly_contest_426_p2/outputs"  # Output file to store test cases and results
c_folder = "../src"  # Folder containing the C source code
c_file = "weekly_contest_426_p2.c"  # C source file name
    ...
    try:
        ...
        with open(output_file, "w") as f:
            for case_id in range(1, test_cases + 1):
                ...
                # Remove newline at the end of formatted_input if it exists
