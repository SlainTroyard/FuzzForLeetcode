...
# File Configs
output_file = "../../../fuzz_outputs/C/weekly_contest_422_p4/outputs"  # Output file to store test cases and results
c_folder = "../src"  # Folder containing the C source code
c_file = "weekly_contest_422_p4.c"  # C source file name
...
def generate_test_input(force_nonzero=False):
    ...
    # 限制长度为MAX_NUM_LENGTH-1，与C程序中的限制保持一致
    max_length = 80  # C程序中的MAX_NUM_LENGTH是81，但要留1个字符给null终止符
...
def simulate_output(test_input):
    ...
    try:
        ...
        process = subprocess.run(run_command, input=formatted_input, text=True, capture_output=True, timeout=10)  # 增加超时时间到10秒
