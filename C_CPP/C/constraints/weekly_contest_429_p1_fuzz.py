...
max_array_size = 100  # Maximum size of the array
min_value = 1  # Minimum value in the array
max_value = 100  # Maximum value in the array

# File Configs
output_file = "../../../fuzz_outputs/C/weekly_contest_429_p1/outputs"  # Output file to store test cases and results
c_folder = "../src"  # Folder containing the C source code
c_file = "weekly_contest_429_p1.c"  # C source file name
