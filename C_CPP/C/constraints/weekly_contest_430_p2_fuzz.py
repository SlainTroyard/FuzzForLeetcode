...
max_word_length = 5000  # Maximum length of the word

# File Configs
output_file = "../../../fuzz_outputs/C/weekly_contest_430_p2/outputs"  # Output file to store test cases and results
c_folder = "../src"  # Folder containing the C source code
c_file = "weekly_contest_430_p2.c"  # C source file name
