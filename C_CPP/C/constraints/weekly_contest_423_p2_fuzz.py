...
max_k = 10000  # Maximum value for k

# File Configs
output_file = "../../../fuzz_outputs/C/weekly_contest_423_p2/outputs"  # Output file to store test cases and results
c_folder = "../src"  # Folder containing the C source code
c_file = "weekly_contest_423_p2.c"  # C source file name
