...
test_cases = 10  # 设置为10个测试用例，与C++版本相同

# File Configs
output_file = "../../../fuzz_outputs/C/weekly_contest_422_p3/outputs"  # Output file to store test cases and results
c_folder = "../src"  # Folder containing the C source code
c_file = "weekly_contest_422_p3.c"  # C source file name
...
def generate_test_input():
    ...
    n = random.randint(2, 750)
    m = random.randint(2, 750)
