...
min_length = 1  # Minimum length of the binary string
max_length = 100000  # Maximum length of the binary string

# File Configs
output_file = "../../../fuzz_outputs/C/weekly_contest_429_p4/outputs"  # Output file to store test cases and results
c_folder = "../src"  # Folder containing the C source code
c_file = "weekly_contest_429_p4.c"  # C source file name
